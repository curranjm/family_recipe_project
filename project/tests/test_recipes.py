...
class ProjectTests(unittest.TestCase):
    ...
    def test_add_recipe(self):
        response = self.app.post(
            '/add',
            data=dict(recipe_title='Hamburgers', recipe_description='Delicious hamburger with pretzel rolls'),
    ...
    def test_add_invalid_recipe(self):
        response = self.app.post(
            '/add',
            data=dict(recipe_title='', recipe_description='Delicious hamburger with pretzel rolls'),
            follow_redirects=True)
